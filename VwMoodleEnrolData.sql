...
WHERE (dbo.TblTeachingManagerSubjects.txtSubjectName NOT IN ('Private Study', 'Non Class', 'Conversation', 'Fixtures', 'Sport', 'Study', 'SEN', 'Lunch/Activities', 'Scholarship', 'Enrichment', 'Lifeskills')) AND (dbo.TblPupilManagementPupils.intSystemStatus = 1) AND (dbo.TblPupilManagementPupils.txtEmailAddress IS NOT NULL)
UNION ALL
...
WHERE (dbo.TblTeachingManagerSubjects.txtSubjectName NOT IN ('Private Study', 'Non Class', 'Conversation', 'Fixtures', 'Sport', 'Study', 'SEN', 'Lunch/Activities', 'Scholarship', 'Enrichment', 'Lifeskills')) AND (dbo.TblTeachingManagerSets.txtTeacher IS NOT NULL) 
UNION ALL
...
WHERE (dbo.TblTeachingManagerSubjects.txtSubjectName NOT IN ('Private Study', 'Non Class', 'Conversation', 'Fixtures', 'Sport', 'Study', 'SEN', 'Lunch/Activities', 'Scholarship', 'Enrichment', 'Lifeskills')) AND (dbo.TblTeachingManagerSetAssociatedTeachers.txtTeacher IS NOT NULL)
UNION
